...
education:
  ...
  - course: MBA in Data Science and Analytics
    institution: ESALQ, Universidade de São Paulo
    year: 2023
  - course: MSc em Matemática Aplicada e Estatística
    institution: Universidade Federal do Ro Grande do Norte
    year: 2019
  - course: BA em Estatística
    institution: Universidade Estadual da Paraíba
    year: 2016
email: "cleanderson@servidor.uepb.edu.br"
highlight_name: true
interests:
- Survival Analysis
- Regression Models
...
- icon: graduation-cap
  icon_pack: fas
  link: https://scholar.google.com/citations?user=ycGJCRIAAAAJ&hl=pt-BR
- icon: scroll
  icon_pack: fas
  link: http://lattes.cnpq.br/9961081404113997
- icon: github
  icon_pack: fab
